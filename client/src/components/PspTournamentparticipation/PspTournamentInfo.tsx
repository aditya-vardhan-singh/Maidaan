...
function PspTournamentInfo({ page, setPage }: NavProps) {
  ...
  const handleInputChange = (index: number, field: string, value: string) => {
    ...
    updatedSportsData[index][field as keyof (typeof updatedSportsData)[0]] =
      value;
  ...
  return (
    <>
      <Container className={styles.formContainer}>
              ...
              <Grid>
                ...
                <Grid.Col span={12}>
                  <Select
                    ...
                    onChange={(value) =>
                      handleInputChange(index, "sport", value!)
                    }
                  />
                </Grid.Col>
                <Grid.Col span={12}>
                ...
                <Grid.Col span={12}>
                  <Select
                    ...
                    onChange={(value) =>
                      handleInputChange(index, "experience", value!)
                    }
                  />
                </Grid.Col>
                <Grid.Col span={12}>
                  <Button color="red" onClick={() => removeSport(index)}>
                    Remove Tournament
                  </Button>
                </Grid.Col>
              </Grid>
        ...
        <Group mt="md">
          <Button color="green" onClick={addSport}>
            + Add Tournament
          </Button>
        </Group>
        <Group mt="md">
          <Button
            onClick={() => setPage("Sport Profile")}
